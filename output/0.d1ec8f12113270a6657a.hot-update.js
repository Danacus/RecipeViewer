...
exports.appInstance = exports.default = exports.stores = undefined;
...
var _CreateProfilePage = __webpack_require__(372);
...
var App = function (_Component) {
  ...
  function App() {
    ...
    exports.appInstance = appInstance = _this;
  ...
  _createClass(App, [{
    ...
    value: function reset() {
      ...
      stores.networks = new _Networks2.default();

      stores.settings.loadSettings().then(function (settings) {
        if (settings) {
          stores.recipes.loadRecipes(settings.getCurrentProfile().path).then(function () {
            stores.nameMaps.loadTooltipMap(settings.getCurrentProfile().path).then(function () {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/homepage',
              render: function render(routeProps) {
                return _react2.default.createElement(_HomePage2.default, _extends({}, routeProps, { networks: stores.networks, settings: stores.settings }));
              }
            }),
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/firstlaunch',
              render: function render(routeProps) {
                return _react2.default.createElement(_CreateProfilePage2.default, { settings: stores.settings });
              }
            }),
