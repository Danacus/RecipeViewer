...
var CreateProfilePage = (0, _mobxReact.observer)(_class = function (_Component) {
  ...
  _createClass(CreateProfilePage, [{
    key: 'onChangeName',
    value: function onChangeName(path) {
      this.setState({ nameInputValue: path });
    }
  }, {
    key: 'onChangePath',
    ...
    value: function setCurrentStep(currentStep) {
      ...
      if (currentStep == 1) {
        this.props.settings.changeSettings(function (settings) {
          return settings.profiles.push({ name: _this4.state.nameInputValue });
        });
      }
    ...
    value: function checkExporter() {
      ...
      _fsJetpack2.default.existsAsync(this.state.path + '/config/jeiexporter/exports').then(function (result) {
        if (result == 'dir') {
          _this5.setState({ exporterInstalled: true, profileIndex: _this5.props.settings.list.profiles.length });
          _this5.setCurrentStep(3);
          _this5.props.settings.changeSettings(function (settings) {
            return settings.profiles.push({ path: _this5.state.path });
          });
          _this5.props.settings.saveSettings();
          if (_App.appInstance) {
            _App.appInstance.reset();
          }
        } else {
          _this5.setState({ exporterInstalled: false });
        }
      });
    }
  }, {
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  _col2.default,
                  { span: 18 },
                  _react2.default.createElement(_input2.default, { ref: 'nameInput', value: _this6.state.nameInputValue, onChange: function onChange(e) {
                      return _this6.onChangeName(e.target.value);
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    _button2.default,
                    { style: { width: "95%" }, type: 'primary', disabled: _this6.state.path == '', onClick: function onClick() {
                        return _this6.setCurrentStep(1);
                      } },
                    'Next'
                  )
                )
            ...
            return _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  _col2.default,
                  { span: 18 },
                  _react2.default.createElement(_input2.default, { ref: 'pathInput', value: _this6.state.inputValue, onChange: function onChange(e) {
                      return _this6.onChangePath(e.target.value);
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    _button2.default,
                    { style: { width: "95%" }, type: 'primary', disabled: _this6.state.path == '', onClick: function onClick() {
                        return _this6.setCurrentStep(2);
                      } },
                    'Next'
                  )
                )
