            ...
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/',
              render: function render(routeProps) {
                return _react2.default.createElement(
                  'div',
                  null,
                  _this2.state.ready ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/homepage', push: true }) : _this2.state.firstLaunch ? _react2.default.createElement(_reactRouterDom.Redirect, { to: '/firstlaunch', push: true }) : _react2.default.createElement('div', null)
                );
              }
            })
          )
    ...
    value: function reset() {
      ...
      stores.settings.loadSettings().then(function (settings) {
        if (settings) {
          ...
          console.log(_this3.state.ready);
          _this3.setState({ firstLaunch: true });
        }
      });
    }
  }]);
