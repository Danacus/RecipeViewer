...
var Networks = (_class = function () {
  function Networks() {
    ...
    _initDefineProp(this, 'selectedNetwork', _descriptor2, this);
  }

  _createClass(Networks, [{
    key: 'serialize',
    value: function serialize() {
      return { networks: this.networks.map(function (network) {
    ...
    value: function deserialize(data) {
      this.networks = data.networks.map(function (d) {
        return new _Network2.default(new _Stack2.default([''])).deserialize(d);
      });
...
}), _descriptor2 = _applyDecoratedDescriptor(_class.prototype, 'selectedNetwork', [_mobx.observable], {
  enumerable: true,
  initializer: function initializer() {
    return 0;
  }
