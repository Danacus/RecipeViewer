...
var _FirstLaunchPage = __webpack_require__(792);
...
var FirstLaunchPage = (0, _mobxReact.observer)(_class = function (_Component) {
  _inherits(FirstLaunchPage, _Component);

  function FirstLaunchPage(props) {
    _classCallCheck(this, FirstLaunchPage);

    var _this = _possibleConstructorReturn(this, (FirstLaunchPage.__proto__ || Object.getPrototypeOf(FirstLaunchPage)).call(this, props));
    ...
    value: function checkExporter() {
      ...
      _fsJetpack2.default.existsAsync(this.state.path + '/config/jeiexporter/exports').then(function (result) {
        if (result == 'dir') {
          ...
          _this4.props.settings.setSettings({ path: _this4.state.path });
...
exports.default = FirstLaunchPage;
